    ...
    <q-header elevated class="bg-white text-grey-8" height-hint="64">
      <q-toolbar class="GNL__toolbar">
        ...
        <q-toolbar-title v-if="$q.screen.gt.xs" shrink class="row items-center no-wrap">
          <span class="q-ml-sm">CITE</span>
        </q-toolbar-title>

        <q-space />

        <q-input class="GNL__toolbar-input" outlined dense v-model="search" color="bg-grey-7 shadow-1" placeholder="Buscar">
...
export default {
  ...
  setup () {
    ...
    return {
      ...
      links1: [
        { icon: 'app_registration', text: 'Registrar' },
        { icon: 'security', text: 'Seguridad' },
        { icon: 'star_border', text: '/' },
        { icon: 'search', text: '/' }
      ],
      links2: [
        { icon: 'flag', text: '/' },
        { icon: fasEarthAmericas, text: '/' },
        { icon: 'place', text: '/' },
        { icon: 'domain', text: '/' },
        { icon: 'memory', text: '/' },
        { icon: 'local_movies', text: '/' },
        { icon: 'directions_bike', text: '/' },
        { icon: fasFlask, text: '/' },
        { icon: 'fitness_center', text: '/ ' }
      ],
      onClear,
      changeDate,
      toggleLeftDrawer
